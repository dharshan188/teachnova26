...
import { withFaultInjection, applyLow02Typo } from '@/lib/server/fault-injection-handlers'
// Server-only validation for fault injection (LOW-03)
...
export async function GET(
  ...
  return withFaultInjection('LOW-02', async () => {
