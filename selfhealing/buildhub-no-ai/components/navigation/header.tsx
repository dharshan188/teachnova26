    ...
    <header className="sticky top-0 z-20 flex h-16 items-center gap-3 border-b border-bh-line bg-bh-surface/90 px-4 backdrop-blur sm:px-6">
      ...
      <div className="ml-auto flex items-center gap-1.5">
        {!user ? (
          ...
          <>
            <span
              className="hidden items-center gap-1.5 rounded-full border border-bh-line bg-bh-surface-2 px-2.5 py-0.5 text-xs font-medium text-bh-muted sm:inline-flex"
              title="BuildHub No-AI demo — AI self-healing is disabled"
            >
              <Icon name="shield" size={12} className="text-bh-accent" />
              NO-AI DEMO
            </span>
            <Dropdown
              menuLabel="User menu"
